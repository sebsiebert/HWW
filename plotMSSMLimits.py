...
if args.higgs_bg or args.higgs_injected:
    ...
    legend = ROOT.TLegend(0.55, 0.7, 0.75, 0.90, '', 'NBNDC') #plot.PositionedLegend(0.15, 0.2, 3, 0.015) #0.25
...
for src in args.input:
    ...
    if len(splitsrc) == 1:
        ...
        if args.higgs_bg or args.higgs_injected or args.plot_exp_points or args.use_hig_17_020_style or style_dict==style_dict_HWW:
...
if args.addSM:
    SM_dict = {
        ...
        'legend' : {
            'exp0' : { 'Label' : 'Exp. for SM-like Higgs'}
            }
